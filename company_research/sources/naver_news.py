...
from company_research.config import NAVER_CLIENT_ID, NAVER_CLIENT_SECRET, NAVER_NEWS_URL
...
class NaverNewsSource(BaseSource):
    ...
    async def fetch(self, company_name: str, **kwargs) -> dict:
        ...
        if not NAVER_CLIENT_ID or not NAVER_CLIENT_SECRET:
            logger.warning("NAVER_CLIENT_ID 또는 NAVER_CLIENT_SECRET이 설정되지 않았습니다.")
        ...
        try:
            ...
            logger.error("네이버 뉴스 API 오류 (%d): %s", exc.response.status_code, exc)
