...
def render():
    ...
    with st.expander("Quick Start", expanded=not apps):
        st.markdown(
            "1. Company Research -> Analyze target company  \n"
            "2. JD Parser -> Parse job description from URL  \n"
            "3. JD-Resume Match -> Check ATS score  \n"
            "4. Resume Optimize -> Improve score  \n"
            "5. Cover Letter -> Generate tailored letter  \n"
            "6. Interview Prep -> Prepare for interviews"
        )
